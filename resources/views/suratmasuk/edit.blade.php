                ...
                <form action="{{ route('suratmasuks.update', $suratmasuk->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="nosurat"
                                ...
                                placeholder="Masukkan No.Surat" value="{{ $suratmasuk->no_surat }}">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input type="date" name="tglsurat"
                                ...
                                placeholder="Masukkan Tgl. Surat" value="{{ $suratmasuk->tgl_surat }}">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input type="date" name="tglmasuk"
                                class="form-control @if ($errors->has('tglmasuk')) is-invalid @endif"
                                placeholder="Masukkan Tgl. Masuk" value="{{ $suratmasuk->tgl_masuk }}">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input type="text" name="pengirim"
                                class="form-control @if ($errors->has('pengirim')) is-invalid @endif"
                                placeholder="Masukkan Pengirim Surat" value="{{ $suratmasuk->pengirim }}">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <textarea name="isi" class="form-control @if ($errors->has('isi')) is-invalid @endif"
                                placeholder="Masukkan Isi Ringkas" rows="5">{{ $suratmasuk->ringkasan }}</textarea>
                            @if ($errors->has('isi'))
                                <small class="text-danger">
                                    {{ $errors->first('isi') }}
                                </small>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <a href="{{ url('suratmasukfile/' . $suratmasuk->file_surat) }}" target="_blank"
