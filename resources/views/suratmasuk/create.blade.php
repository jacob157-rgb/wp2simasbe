    ...
    <div class="card">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input type="date" name="tglsurat"
                            ...
                            placeholder="Masukkan Tgl. Surat" value="{{ old('tglsurat') }}">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input type="date" name="tglmasuk"
                            ...
                            placeholder="Masukkan Tgl. Masuk" value="{{ old('tglmasuk') }}">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input type="text" name="pengirim"
                            ...
                            placeholder="Masukkan Pengirim Surat" value="{{ old('pengirim') }}">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <textarea name="isi" class="form-control @if ($errors->has('isi')) is-invalid @endif"
                            placeholder="Masukkan Isi Ringkas" rows="5"></textarea>
                        @if ($errors->has('isi'))
                        <small class="text-danger">
                            {{$errors->first('isi')}}
                        </small>
        ...
        <div class="card-footer">
            <div class="my-2">
                ...
                <a href="{{route('suratmasuks.index')}}" class="btn btn-danger"><i class="fa fa-backward"></i>
                    Kembali</a>
            </div>
            </form>
        </div>
