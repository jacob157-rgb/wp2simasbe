        ...
        <div class="card-header">
            <div class="card-title pt-2">
                <h4>Data Surat Keluar&nbsp;
                    <a href="{{route('suratkeluars.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah
                        Data</a>&nbsp;
                    <a href="{{url('suratkeluarimport')}}" class="btn btn-warning"><i class="fa fa-upload"></i> Import
                        Data</a>&nbsp;
                    <a href="{{url('suratkeluarpdf')}}" class="btn btn-danger"><i class="fa-solid fa-file-pdf"></i>Export
                        PDF</a>
                </h4>
            </div>
        </div>
